...
class Pedido {
    ...
    private List<ItemPedido> itens; // Composição - um pedido pode ter muitos itens, por isso é uma lista

    public Pedido(int idPedido, Date data, double valorDesconto) {
